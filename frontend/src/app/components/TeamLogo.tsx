...
export function TeamLogo({ teamName, size = 'md', imageUrl = null }: TeamLogoProps) {
  ...
  return (
    <div className={`relative ${sizeClasses[size]} flex items-center justify-center`}>
      ...
      {/* Team badge */}
      <div
        className="relative rounded-full flex items-center justify-center font-bold shadow-lg border-2 overflow-hidden"
        style={{
